...
//        Put put1 = new Put(Bytes.toBytes("Timy"));
//        put1.addColumn(Bytes.toBytes("baseinfo"),Bytes.toBytes("age"),Bytes.toBytes("22"));
//        put1.addColumn(Bytes.toBytes("moreinfo"),Bytes.toBytes("tel"),Bytes.toBytes("666"));
//        Put put2 = new Put(Bytes.toBytes("Jack"));
//        put2.addColumn(Bytes.toBytes("baseinfo"),Bytes.toBytes("age"),Bytes.toBytes("18"));
//        put2.addColumn(Bytes.toBytes("moreinfo"),Bytes.toBytes("tel"),Bytes.toBytes("444"));
//        puts.add(put1);
//        puts.add(put2);
